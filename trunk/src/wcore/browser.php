 ...
 * 慧佳工作室 -> hoojar studio
 *
 * 模块: wcore/browser.php
 * 简述: 浏览器信息
 * 作者: woods·zhang     ->     hoojar@163.com
 * 版本: $Id: chart.php 79 2012-10-11 10:39:41Z Administrator $
...
class wcore_browser
{
	...
	protected function checkBrowserMozilla()
	{
		...
		else if (preg_match('/mozilla/i', $this->_agent) && preg_match('/rv:[0-9]\.[0-9]/i', $this->_agent) && !preg_match('/netscape/i', $this->_agent))
		{
			...
			echo $this->setVersion(str_replace('rv:', '', $aversion[0]));
			$this->setBrowser(self::BROWSER_MOZILLA);
			$retval = true;
		}
