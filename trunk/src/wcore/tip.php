 ...
 * 版本: $Id: tip.php 1 2012-11-20 05:55:12Z Administrator $
...
class wcore_tip
{
	...
	public static function show($msg, $url = '', $second = 3)
	{
		...
		echo('#body{margin:10px auto;padding:20px;width:888px;background-color:#FFFFFF;border:1px solid #A9B8C2;border-radius:5px;');
