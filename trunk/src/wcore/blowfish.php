 ...
 * 张树林 - 慧佳工作室
 *
 * 模块: wcore/blowfish.php
 * 简述: blowfish加密与解密
 * 作者: woods·zhang  ->  hoojar@163.com
 * 版本: $Id: blowfish.php 1 2012-11-20 05:55:12Z Administrator $
 * 版权: Copyright 2006-2013 慧佳工作室拥有此系统所有版权等知识产权
 *
 */
/*
$crypt = new wcore_blowfish(MODE_ECB, "secretkey");
$plaintext  = 'Test blowfish encode and decode';
$ciphertext = base64_encode($crypt->encrypt($plaintext));
$decrypted  = $crypt->decrypt(base64_decode($ciphertext));
echo "{$plaintext}<br />{$ciphertext}<br />{$decrypted}";
*/
define("MODE_ECB", 0); //const MODE_ECB ecb mode
define("MODE_CBC", 1); //const MODE_CBC cbc mode

class wcore_blowfish
{
	 ...
	 * @return void
	 */
	public function __construct($blockmode = MODE_ECB, $key = null)
	{
