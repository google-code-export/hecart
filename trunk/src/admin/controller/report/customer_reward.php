...
class ControllerReportCustomerReward extends Controller
{
	public function index()
	{
		...
		$this->data['breadcrumbs'][] = array(
			...
			'href'      => $this->url->link('report/customer_reward', $url, 'SSL'),
			'separator' => ' :: '
		);
		...
		$pagination->url                 = $this->url->link('report/customer_reward', $url . '&page={page}', 'SSL');
		$this->data['pagination']        = $pagination->render();
		$this->data['filter_date_start'] = $filter_date_start;
		$this->data['filter_date_end']   = $filter_date_end;

		$this->template = 'template/report/customer_reward.tpl';
		$this->children = array(
			'common/header',
			'common/footer'
		);
