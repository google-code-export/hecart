...
class ControllerReportProductViewed extends Controller
{
	public function index()
	{
		...
		$this->data['breadcrumbs'][] = array(
			...
			'href'      => $this->url->link('report/product_viewed', $url, 'SSL'),
			'separator' => ' :: '
		);
		...
		$this->data['reset'] = $this->url->link('report/product_viewed/reset', $url, 'SSL');
		...
		$this->template = 'template/report/product_viewed.tpl';
		$this->children = array(
			'common/header',
			'common/footer'
		);
