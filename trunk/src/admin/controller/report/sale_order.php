...
class ControllerReportSaleOrder extends Controller
{
	public function index()
	{
		...
		$this->data['breadcrumbs'][] = array(
			...
			'href'      => $this->url->link('report/sale_order', $url, 'SSL'),
			'separator' => ' :: '
		);
		...
		$pagination->url                      = $this->url->link('report/sale_order', $url . '&page={page}', 'SSL');
		...
		$this->template = 'template/report/sale_order.tpl';
		$this->children = array(
			'common/header',
			'common/footer'
		);
