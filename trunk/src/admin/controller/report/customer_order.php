...
class ControllerReportCustomerOrder extends Controller
{
	public function index()
	{
		...
		$this->data['breadcrumbs'][] = array(
			...
			'href'      => $this->url->link('report/customer_order', $url, 'SSL'),
			'separator' => ' :: '
		);
		...
		$pagination->url                      = $this->url->link('report/customer_order', $url . '&page={page}', 'SSL');
		$this->data['pagination']             = $pagination->render();
		$this->data['filter_date_start']      = $filter_date_start;
		$this->data['filter_date_end']        = $filter_date_end;
		$this->data['filter_order_status_id'] = $filter_order_status_id;

		$this->template = 'template/report/customer_order.tpl';
		$this->children = array(
			'common/header',
			'common/footer'
		);
