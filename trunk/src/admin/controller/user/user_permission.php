...
class ControllerUserUserPermission extends Controller
{
	...
	private function getList()
	{
		...
		$this->data['insert']      = $this->url->link('user/user_permission/insert', $url, 'SSL');
		...
		foreach ($results as $result)
		{
			...
			$action[]                    = array(
				...
				'href' => $this->url->link('user/user_permission/update', '&user_group_id=' . $result['user_group_id'] . $url, 'SSL')
			);
			$this->data['user_groups'][] = array(
		...
		$this->template           = 'template/user/user_group_list.tpl';
		$this->children           = array(
			'common/header',
			'common/footer'
		);
	...
	private function getForm()
	{
		...
		{
			$this->data['action'] = $this->url->link('user/user_permission/insert', $url, 'SSL');
		}
		else
		{
			$this->data['action'] = $this->url->link('user/user_permission/update', '&user_group_id=' . $this->request->get['user_group_id'] . $url, 'SSL');
		}

		$this->data['cancel'] = $this->url->link('user/user_permission', $url, 'SSL');
		...
		$this->template = 'template/user/user_group_form.tpl';
		$this->children = array(
			'common/header',
			'common/footer'
		);
