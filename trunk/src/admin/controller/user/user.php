...
class ControllerUserUser extends Controller
{
	...
	public function insert()
	{
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm())
		{
			...
			$this->redirect($this->url->link('user/user', $url, 'SSL'));
		}
	...
	private function getList()
	{
		...
		$this->data['breadcrumbs'][] = array(
			...
			'href'      => $this->url->link('user/user', $url, 'SSL'),
			'separator' => ' :: '
		);
		$this->data['insert']        = $this->url->link('user/user/insert', $url, 'SSL');
		$this->data['delete']        = $this->url->link('user/user/delete', $url, 'SSL');
		...
		foreach ($results as $result)
		{
			...
			$action[]              = array(
				...
				'href' => $this->url->link('user/user/update', '&user_id=' . $result['user_id'] . $url, 'SSL')
			);
			$this->data['users'][] = array(
		...
		$this->data['sort_username']   = $this->url->link('user/user', '&sort=username' . $url, 'SSL');
		$this->data['sort_status']     = $this->url->link('user/user', '&sort=status' . $url, 'SSL');
		$this->data['sort_date_added'] = $this->url->link('user/user', '&sort=date_added' . $url, 'SSL');
		$url                           = '';
		...
		$this->template           = 'template/user/user_list.tpl';
		$this->children           = array(
			'common/header',
			'common/footer'
		);
	...
	private function getForm()
	{
		...
		{
			$this->data['action'] = $this->url->link('user/user/insert', $url, 'SSL');
		}
		else
		{
			$this->data['action'] = $this->url->link('user/user/update', '&user_id=' . $this->request->get['user_id'] . $url, 'SSL');
		}

		$this->data['cancel'] = $this->url->link('user/user', $url, 'SSL');
		...
		$this->template = 'template/user/user_form.tpl';
		$this->children = array(
			'common/header',
			'common/footer'
		);
