...
class ControllerLocalisationZone extends Controller
{
	...
	{
		$zone_id = (int)$this->request->get['zone_id'];
		...
		if (empty($res))
		{
			$json = array();
			$this->load->model('localisation/zone');
			$json = $this->model_localisation_zone->getCitysByZoneId($zone_id);
	...
	public function insert()
	{
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm())
		{
			...
			$this->redirect($this->url->link('localisation/zone', $url, 'SSL'));
		}
	...
	private function getList()
	{
		...
		$this->data['breadcrumbs'][] = array(
			...
			'href'      => $this->url->link('localisation/zone', $url, 'SSL'),
			'separator' => ' :: '
		);
		$this->data['insert']        = $this->url->link('localisation/zone/insert', $url, 'SSL');
		$this->data['delete']        = $this->url->link('localisation/zone/delete', $url, 'SSL');
		...
		foreach ($results as $result)
		{
			...
			$action[]              = array(
				...
				'href' => $this->url->link('localisation/zone/update', '&zone_id=' . $result['zone_id'] . $url, 'SSL')
			);
			$this->data['zones'][] = array(
		...
		$this->data['sort_country'] = $this->url->link('localisation/zone', '&sort=c.name' . $url, 'SSL');
		$this->data['sort_name']    = $this->url->link('localisation/zone', '&sort=z.name' . $url, 'SSL');
		$this->data['sort_code']    = $this->url->link('localisation/zone', '&sort=z.code' . $url, 'SSL');
		$url                        = '';
		...
		$pagination->url          = $this->url->link('localisation/zone', $url . '&page={page}', 'SSL');
		$this->data['pagination'] = $pagination->render();
		$this->data['sort']       = $sort;
		$this->data['order']      = $order;
		$this->template           = 'template/localisation/zone_list.tpl';
		$this->children           = array(
			'common/header',
			'common/footer'
		);
	...
	private function getForm()
	{
		...
		{
			$this->data['action'] = $this->url->link('localisation/zone/insert', $url, 'SSL');
		}
		else
		{
			$this->data['action'] = $this->url->link('localisation/zone/update', '&zone_id=' . $this->request->get['zone_id'] . $url, 'SSL');
		}

		$this->data['cancel'] = $this->url->link('localisation/zone', $url, 'SSL');
		...
		$this->template          = 'template/localisation/zone_form.tpl';
		$this->children          = array(
			'common/header',
			'common/footer'
		);
