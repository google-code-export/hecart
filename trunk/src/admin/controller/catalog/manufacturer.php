...
class ControllerCatalogManufacturer extends Controller
{
	...
	public function insert()
	{
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm())
		{
			...
			$this->redirect($this->url->link('catalog/manufacturer', $url, 'SSL'));
		}
	...
	private function getList()
	{
		...
		$this->data['breadcrumbs'][] = array(
			...
			'href'      => $this->url->link('catalog/manufacturer', $url, 'SSL'),
			'separator' => ' :: '
		);
		$this->data['insert']        = $this->url->link('catalog/manufacturer/insert', $url, 'SSL');
		$this->data['delete']        = $this->url->link('catalog/manufacturer/delete', $url, 'SSL');
		...
		foreach ($results as $result)
		{
			...
			$action[]                      = array(
				...
				'href' => $this->url->link('catalog/manufacturer/update', '&manufacturer_id=' . $result['manufacturer_id'] . $url, 'SSL')
			);
			$this->data['manufacturers'][] = array(
		...
		$this->data['sort_name']       = $this->url->link('catalog/manufacturer', '&sort=name' . $url, 'SSL');
		$this->data['sort_sort_order'] = $this->url->link('catalog/manufacturer', '&sort=sort_order' . $url, 'SSL');
		$url                           = '';
		...
		$pagination->url          = $this->url->link('catalog/manufacturer', $url . '&page={page}', 'SSL');
		$this->data['pagination'] = $pagination->render();
		$this->data['sort']       = $sort;
		$this->data['order']      = $order;
		$this->template           = 'template/catalog/manufacturer_list.tpl';
		$this->children           = array(
			'common/header',
			'common/footer'
		);
	...
	private function getForm()
	{
		...
		{
			$this->data['action'] = $this->url->link('catalog/manufacturer/insert', $url, 'SSL');
		}
		else
		{
			$this->data['action'] = $this->url->link('catalog/manufacturer/update', '&manufacturer_id=' . $this->request->get['manufacturer_id'] . $url, 'SSL');
		}

		$this->data['cancel'] = $this->url->link('catalog/manufacturer', $url, 'SSL');
		...
		$this->template = 'template/catalog/manufacturer_form.tpl';
		$this->children = array(
			'common/header',
			'common/footer'
		);
