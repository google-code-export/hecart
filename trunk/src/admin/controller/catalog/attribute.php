...
class ControllerCatalogAttribute extends Controller
{
	...
	public function insert()
	{
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm())
		{
			...
			$this->redirect($this->url->link('catalog/attribute', $url, 'SSL'));
		}
	...
	private function getList()
	{
		...
		$this->data['breadcrumbs'][] = array(
			...
			'href'      => $this->url->link('catalog/attribute', $url, 'SSL'),
			'separator' => ' :: '
		);
		$this->data['insert']        = $this->url->link('catalog/attribute/insert', $url, 'SSL');
		$this->data['delete']        = $this->url->link('catalog/attribute/delete', $url, 'SSL');
		...
		foreach ($results as $result)
		{
			...
			$action[]                   = array(
				...
				'href' => $this->url->link('catalog/attribute/update', '&attribute_id=' . $result['attribute_id'] . $url, 'SSL')
			);
			$this->data['attributes'][] = array(
		...
		$this->data['sort_name']            = $this->url->link('catalog/attribute', '&sort=ad.name' . $url, 'SSL');
		$this->data['sort_attribute_group'] = $this->url->link('catalog/attribute', '&sort=attribute_group' . $url, 'SSL');
		$this->data['sort_sort_order']      = $this->url->link('catalog/attribute', '&sort=a.sort_order' . $url, 'SSL');
		$url                                = '';
		...
		$pagination->url          = $this->url->link('catalog/attribute', $url . '&page={page}', 'SSL');
		$this->data['pagination'] = $pagination->render();
		$this->data['sort']       = $sort;
		$this->data['order']      = $order;
		$this->template           = 'template/catalog/attribute_list.tpl';
		$this->children           = array(
			'common/header',
			'common/footer'
		);
	...
	private function getForm()
	{
		...
		{
			$this->data['action'] = $this->url->link('catalog/attribute/insert', $url, 'SSL');
		}
		else
		{
			$this->data['action'] = $this->url->link('catalog/attribute/update', '&attribute_id=' . $this->request->get['attribute_id'] . $url, 'SSL');
		}

		$this->data['cancel'] = $this->url->link('catalog/attribute', $url, 'SSL');
		...
		$this->template = 'template/catalog/attribute_form.tpl';
		$this->children = array(
			'common/header',
			'common/footer'
		);
