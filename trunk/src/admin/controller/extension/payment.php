...
class ControllerExtensionPayment extends Controller
{
	public function index()
	{
			...
			foreach ($files as $file)
			{
				...
				if (!in_array($extension, $extensions))
				{
					$action[] = array(
						...
						'href' => $this->url->link('extension/payment/install', '&extension=' . $extension, 'SSL')
					);
				}
				else
				{
					...
					$action[] = array(
						...
						'href' => $this->url->link('extension/payment/uninstall', '&extension=' . $extension, 'SSL')
					);
				}
		...
		$this->template = 'template/extension/payment.tpl';
		$this->children = array(
			'common/header',
			'common/footer'
		);
