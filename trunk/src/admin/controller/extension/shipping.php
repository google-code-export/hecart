...
class ControllerExtensionShipping extends Controller
{
	public function index()
	{
		...
		$this->data['breadcrumbs'][]     = array(
			...
			'href'      => $this->url->link('extension/shipping'),
			'separator' => ' :: '
		);
		...
		{
			if (!file_exists(DIR_SITE . '/controller/shipping/' . $value . '.php'))
			{
		...
		$files                    = glob(DIR_SITE . '/controller/shipping/*.php');
			...
			foreach ($files as $file)
			{
				...
				if (!in_array($extension, $extensions))
				{
					$action[] = array(
						...
						'href' => $this->url->link('extension/shipping/install', '&extension=' . $extension, 'SSL')
					);
				}
				else
				{
					...
					$action[] = array(
						...
						'href' => $this->url->link('extension/shipping/uninstall', '&extension=' . $extension, 'SSL')
					);
				}
		...
		$this->template = 'template/extension/shipping.tpl';
		$this->children = array(
			'common/header',
			'common/footer'
		);
	...
	public function install()
	{
		...
		else
		{
			...
			require(DIR_SITE . '/controller/shipping/' . $this->request->get['extension'] . '.php');
