...
class ControllerPaymentPayza extends Controller
{
	...
	public function index()
	{
		...
		$this->data['breadcrumbs'][] = array(
			...
			'href'      => $this->url->link('payment/payza'),
			'separator' => ' :: '
		);
		$this->data['action']        = $this->url->link('payment/payza');
		...
		$this->data['callback'] = HTTP_STORE . 'index.php?route=payment/payza/callback';
		...
		$this->template = 'template/payment/payza.tpl';
		$this->children = array(
			'common/header',
			'common/footer'
		);
