...
class ControllerFeedGoogleSitemap extends Controller
{
	...
	public function index()
	{
		...
		$this->data['breadcrumbs'][] = array(
			...
			'href'      => $this->url->link('feed/google_sitemap'),
			'separator' => ' :: '
		);
		...
		$this->data['data_feed'] = HTTP_STORE . 'index.php?route=feed/google_sitemap';
		$this->template          = 'template/feed/google_sitemap.tpl';
		$this->children          = array(
			'common/header',
			'common/footer'
		);
