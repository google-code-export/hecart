...
class ControllerDesignLayout extends Controller
{
	...
	public function insert()
	{
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm())
		{
			...
			$this->redirect($this->url->link('design/layout', $url, 'SSL'));
		}
	...
	private function getList()
	{
		...
		$this->data['breadcrumbs'][] = array(
			...
			'href'      => $this->url->link('design/layout', $url, 'SSL'),
			'separator' => ' :: '
		);
		$this->data['insert']        = $this->url->link('design/layout/insert', $url, 'SSL');
		$this->data['delete']        = $this->url->link('design/layout/delete', $url, 'SSL');
		...
		foreach ($results as $result)
		{
			...
			$action[]                = array(
				...
				'href' => $this->url->link('design/layout/update', '&layout_id=' . $result['layout_id'] . $url, 'SSL')
			);
			$this->data['layouts'][] = array(
		...
		$this->data['sort_name'] = $this->url->link('design/layout', '&sort=name' . $url, 'SSL');
		$url                     = '';
		...
		$pagination->url          = $this->url->link('design/layout', $url . '&page={page}', 'SSL');
		$this->data['pagination'] = $pagination->render();
		$this->data['sort']       = $sort;
		$this->data['order']      = $order;
		$this->template           = 'template/design/layout_list.tpl';
		$this->children           = array(
			'common/header',
			'common/footer'
		);
	...
	private function getForm()
	{
		...
		{
			$this->data['action'] = $this->url->link('design/layout/insert', $url, 'SSL');
		}
		else
		{
			$this->data['action'] = $this->url->link('design/layout/update', '&layout_id=' . $this->request->get['layout_id'] . $url, 'SSL');
		}

		$this->data['cancel'] = $this->url->link('design/layout', $url, 'SSL');
		...
		$this->template = 'template/design/layout_form.tpl';
		$this->children = array(
			'common/header',
			'common/footer'
		);
