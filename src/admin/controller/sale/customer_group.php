...
class ControllerSaleCustomerGroup extends Controller
{
	...
	public function insert()
	{
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm())
		{
			...
			$this->redirect($this->url->link('sale/customer_group', $url, 'SSL'));
		}
	...
	private function getList()
	{
		...
		$this->data['breadcrumbs'][]   = array(
			...
			'href'      => $this->url->link('sale/customer_group', $url, 'SSL'),
			'separator' => ' :: '
		);
		$this->data['insert']          = $this->url->link('sale/customer_group/insert', $url, 'SSL');
		$this->data['delete']          = $this->url->link('sale/customer_group/delete', $url, 'SSL');
		...
		$this->data['sort_name']       = $this->url->link('sale/customer_group', '&sort=cgd.name' . $url, 'SSL');
		$this->data['sort_sort_order'] = $this->url->link('sale/customer_group', '&sort=cg.sort_order' . $url, 'SSL');
		$url                           = '';
		...
		$pagination->url          = $this->url->link('sale/customer_group', $url . '&page={page}', 'SSL');
		$this->data['pagination'] = $pagination->render();
		$this->data['sort']       = $sort;
		$this->data['order']      = $order;
		$this->template           = 'template/sale/customer_group_list.tpl';
		$this->children           = array(
			'common/header',
			'common/footer'
		);
	...
	private function getForm()
	{
		...
		{
			$this->data['action'] = $this->url->link('sale/customer_group/insert', $url, 'SSL');
		}
		else
		{
		...
		$this->data['cancel'] = $this->url->link('sale/customer_group', $url, 'SSL');
		...
		$this->template = 'template/sale/customer_group_form.tpl';
		$this->children = array(
			'common/header',
			'common/footer'
		);
