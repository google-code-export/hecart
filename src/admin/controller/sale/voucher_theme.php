...
class ControllerSaleVoucherTheme extends Controller
{
	...
	public function insert()
	{
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm())
		{
			...
			$this->redirect($this->url->link('sale/voucher_theme', $url, 'SSL'));
		}
	...
	private function getList()
	{
		...
		$this->data['breadcrumbs'][]  = array(
			...
			'href'      => $this->url->link('sale/voucher_theme', $url, 'SSL'),
			'separator' => ' :: '
		);
		$this->data['insert']         = $this->url->link('sale/voucher_theme/insert', $url, 'SSL');
		$this->data['delete']         = $this->url->link('sale/voucher_theme/delete', $url, 'SSL');
		...
		foreach ($results as $result)
		{
			...
			$action[]                       = array(
				...
				'href' => $this->url->link('sale/voucher_theme/update', '&voucher_theme_id=' . $result['voucher_theme_id'] . $url, 'SSL')
			);
			$this->data['voucher_themes'][] = array(
		...
		$this->data['sort_name'] = $this->url->link('sale/voucher_theme', '&sort=name' . $url, 'SSL');
		$url                     = '';
		...
		$pagination->url          = $this->url->link('sale/voucher_theme', $url . '&page={page}', 'SSL');
		$this->data['pagination'] = $pagination->render();
		$this->data['sort']       = $sort;
		$this->data['order']      = $order;
		$this->template           = 'template/sale/voucher_theme_list.tpl';
		$this->children           = array(
			'common/header',
			'common/footer'
		);
	...
	private function getForm()
	{
		...
		{
			$this->data['action'] = $this->url->link('sale/voucher_theme/insert', $url, 'SSL');
		}
		else
		{
			$this->data['action'] = $this->url->link('sale/voucher_theme/update', '&voucher_theme_id=' . $this->request->get['voucher_theme_id'] . $url, 'SSL');
		}

		$this->data['cancel'] = $this->url->link('sale/voucher_theme', $url, 'SSL');
		...
		$this->template         = 'template/sale/voucher_theme_form.tpl';
		$this->children         = array(
			'common/header',
			'common/footer'
		);
