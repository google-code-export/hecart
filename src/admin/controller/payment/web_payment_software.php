...
class ControllerPaymentWebPaymentSoftware extends Controller
{
	...
	public function index()
	{
		...
		$this->data['breadcrumbs'][] = array(
			...
			'href'      => $this->url->link('payment/web_payment_software'),
			'separator' => ' :: '
		);
		$this->data['action']        = 'https://' . DOMAIN_NAME . '/index.php?route=payment/web_payment_software';
		$this->data['cancel']        = 'https://' . DOMAIN_NAME . '/index.php?route=extension/payment';
