...
class ControllerReportSaleReturn extends Controller
{
	public function index()
	{
		...
		$this->data['breadcrumbs'][] = array(
			...
			'href'      => $this->url->link('report/sale_return', $url, 'SSL'),
			'separator' => ' :: '
		);
		...
		$pagination->url                       = $this->url->link('report/sale_return', $url . '&page={page}', 'SSL');
		...
		$this->template = 'template/report/sale_return.tpl';
		$this->children = array(
			'common/header',
			'common/footer'
		);
