...
class ControllerReportSaleCoupon extends Controller
{
	public function index()
	{
		...
		$this->data['breadcrumbs'][] = array(
			...
			'href'      => $this->url->link('report/sale_coupon', $url, 'SSL'),
			'separator' => ' :: '
		);
		...
		$pagination->url                 = $this->url->link('report/sale_coupon', $url . '&page={page}', 'SSL');
		$this->data['pagination']        = $pagination->render();
		$this->data['filter_date_start'] = $filter_date_start;
		$this->data['filter_date_end']   = $filter_date_end;
		$this->template                  = 'template/report/sale_coupon.tpl';
		$this->children                  = array(
			'common/header',
			'common/footer'
		);
