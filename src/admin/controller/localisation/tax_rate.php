...
class ControllerLocalisationTaxRate extends Controller
{
	...
	public function insert()
	{
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm())
		{
			...
			$this->redirect($this->url->link('localisation/tax_rate', $url, 'SSL'));
		}
	...
	private function getList()
	{
		...
		$this->data['breadcrumbs'][] = array(
			...
			'href'      => $this->url->link('localisation/tax_rate', $url, 'SSL'),
			'separator' => ' :: '
		);
		$this->data['insert']        = $this->url->link('localisation/tax_rate/insert', $url, 'SSL');
		$this->data['delete']        = $this->url->link('localisation/tax_rate/delete', $url, 'SSL');
		...
		foreach ($results as $result)
		{
			...
			$action[]                  = array(
				...
				'href' => $this->url->link('localisation/tax_rate/update', '&tax_rate_id=' . $result['tax_rate_id'] . $url, 'SSL')
			);
			$this->data['tax_rates'][] = array(
		...
		$this->data['sort_name']          = $this->url->link('localisation/tax_rate', '&sort=tr.name' . $url, 'SSL');
		$this->data['sort_rate']          = $this->url->link('localisation/tax_rate', '&sort=tr.rate' . $url, 'SSL');
		$this->data['sort_type']          = $this->url->link('localisation/tax_rate', '&sort=tr.type' . $url, 'SSL');
		$this->data['sort_geo_zone']      = $this->url->link('localisation/tax_rate', '&sort=gz.name' . $url, 'SSL');
		$this->data['sort_date_added']    = $this->url->link('localisation/tax_rate', '&sort=tr.date_added' . $url, 'SSL');
		$this->data['sort_date_modified'] = $this->url->link('localisation/tax_rate', '&sort=tr.date_modified' . $url, 'SSL');
		$url                              = '';
		...
		$pagination->url          = $this->url->link('localisation/tax_rate', $url . '&page={page}', 'SSL');
		$this->data['pagination'] = $pagination->render();
		$this->data['sort']       = $sort;
		$this->data['order']      = $order;
		$this->template           = 'template/localisation/tax_rate_list.tpl';
		$this->children           = array(
			'common/header',
			'common/footer'
		);
	...
	private function getForm()
	{
		...
		{
			$this->data['action'] = $this->url->link('localisation/tax_rate/insert', $url, 'SSL');
		}
		else
		{
			$this->data['action'] = $this->url->link('localisation/tax_rate/update', '&tax_rate_id=' . $this->request->get['tax_rate_id'] . $url, 'SSL');
		}

		$this->data['cancel'] = $this->url->link('localisation/tax_rate', $url, 'SSL');
		...
		$this->template          = 'template/localisation/tax_rate_form.tpl';
		$this->children          = array(
			'common/header',
			'common/footer'
		);
