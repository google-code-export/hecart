...
class ControllerLocalisationLengthClass extends Controller
{
	...
	public function insert()
	{
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm())
		{
			...
			$this->redirect($this->url->link('localisation/length_class', $url, 'SSL'));
		}
	...
	private function getList()
	{
		...
		$this->data['breadcrumbs'][] = array(
			...
			'href'      => $this->url->link('localisation/length_class', $url, 'SSL'),
			'separator' => ' :: '
		);
		$this->data['insert']        = $this->url->link('localisation/length_class/insert', $url, 'SSL');
		$this->data['delete']        = $this->url->link('localisation/length_class/delete', $url, 'SSL');
		...
		foreach ($results as $result)
		{
			...
			$action[]                       = array(
				...
				'href' => $this->url->link('localisation/length_class/update', '&length_class_id=' . $result['length_class_id'] . $url, 'SSL')
			);
			$this->data['length_classes'][] = array(
		...
		$this->data['sort_title'] = $this->url->link('localisation/length_class', '&sort=title' . $url, 'SSL');
		$this->data['sort_unit']  = $this->url->link('localisation/length_class', '&sort=unit' . $url, 'SSL');
		$this->data['sort_value'] = $this->url->link('localisation/length_class', '&sort=value' . $url, 'SSL');
		$url                      = '';
		...
		$pagination->url          = $this->url->link('localisation/length_class', $url . '&page={page}', 'SSL');
		$this->data['pagination'] = $pagination->render();
		$this->data['sort']       = $sort;
		$this->data['order']      = $order;
		$this->template           = 'template/localisation/length_class_list.tpl';
		$this->children           = array(
			'common/header',
			'common/footer'
		);
	...
	private function getForm()
	{
		...
		{
			$this->data['action'] = $this->url->link('localisation/length_class/insert', $url, 'SSL');
		}
		else
		{
			$this->data['action'] = $this->url->link('localisation/length_class/update', '&length_class_id=' . $this->request->get['length_class_id'] . $url, 'SSL');
		}

		$this->data['cancel'] = $this->url->link('localisation/length_class', $url, 'SSL');
		...
		$this->template = 'template/localisation/length_class_form.tpl';
		$this->children = array(
			'common/header',
			'common/footer'
		);
