...
class ControllerLocalisationReturnAction extends Controller
{
	...
	public function insert()
	{
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm())
		{
			...
			$this->redirect($this->url->link('localisation/return_action', $url, 'SSL'));
		}
	...
	private function getList()
	{
		...
		$this->data['breadcrumbs'][]  = array(
			...
			'href'      => $this->url->link('localisation/return_action', $url, 'SSL'),
			'separator' => ' :: '
		);
		$this->data['insert']         = $this->url->link('localisation/return_action/insert', $url, 'SSL');
		$this->data['delete']         = $this->url->link('localisation/return_action/delete', $url, 'SSL');
		...
		foreach ($results as $result)
		{
			...
			$action[]                       = array(
				...
				'href' => $this->url->link('localisation/return_action/update', '&return_action_id=' . $result['return_action_id'] . $url, 'SSL')
			);
			$this->data['return_actions'][] = array(
		...
		$this->data['sort_name'] = $this->url->link('localisation/return_action', '&sort=name' . $url, 'SSL');
		$url                     = '';
		...
		$pagination->url          = $this->url->link('localisation/return_action', $url . '&page={page}', 'SSL');
		$this->data['pagination'] = $pagination->render();
		$this->data['sort']       = $sort;
		$this->data['order']      = $order;
		$this->template           = 'template/localisation/return_action_list.tpl';
		$this->children           = array(
			'common/header',
			'common/footer'
		);
	...
	private function getForm()
	{
		...
		{
			$this->data['action'] = $this->url->link('localisation/return_action/insert', $url, 'SSL');
		}
		else
		{
			$this->data['action'] = $this->url->link('localisation/return_action/update', '&return_action_id=' . $this->request->get['return_action_id'] . $url, 'SSL');
		}

		$this->data['cancel'] = $this->url->link('localisation/return_action', $url, 'SSL');
		...
		$this->template = 'template/localisation/return_action_form.tpl';
		$this->children = array(
			'common/header',
			'common/footer'
		);
