...
class ControllerLocalisationTaxClass extends Controller
{
	...
	public function insert()
	{
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm())
		{
			...
			$this->redirect($this->url->link('localisation/tax_class', $url, 'SSL'));
		}
	...
	private function getList()
	{
		...
		$this->data['breadcrumbs'][] = array(
			...
			'href'      => $this->url->link('localisation/tax_class', $url, 'SSL'),
			'separator' => ' :: '
		);
		$this->data['insert']        = $this->url->link('localisation/tax_class/insert', $url, 'SSL');
		$this->data['delete']        = $this->url->link('localisation/tax_class/delete', $url, 'SSL');
		...
		foreach ($results as $result)
		{
			...
			$action[]                    = array(
				...
				'href' => $this->url->link('localisation/tax_class/update', '&tax_class_id=' . $result['tax_class_id'] . $url, 'SSL')
			);
			$this->data['tax_classes'][] = array(
		...
		$this->data['sort_title'] = $this->url->link('localisation/tax_class', '&sort=title' . $url, 'SSL');
		$url                      = '';
		...
		$pagination->url          = $this->url->link('localisation/tax_class', $url . '&page={page}', 'SSL');
		$this->data['pagination'] = $pagination->render();
		$this->data['sort']       = $sort;
		$this->data['order']      = $order;
		$this->template           = 'template/localisation/tax_class_list.tpl';
		$this->children           = array(
			'common/header',
			'common/footer',
		);
	...
	private function getForm()
	{
		...
		{
			$this->data['action'] = $this->url->link('localisation/tax_class/insert', $url, 'SSL');
		}
		else
		{
			$this->data['action'] = $this->url->link('localisation/tax_class/update', '&tax_class_id=' . $this->request->get['tax_class_id'] . $url, 'SSL');
		}

		$this->data['cancel'] = $this->url->link('localisation/tax_class', $url, 'SSL');
		...
		$this->template = 'template/localisation/tax_class_form.tpl';
		$this->children = array(
			'common/header',
			'common/footer',
		);
