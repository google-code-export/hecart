...
class ControllerExtensionTotal extends Controller
{
	public function index()
	{
		...
		{
			if (!file_exists(DIR_SITE . '/controller/total/' . $value . '.php'))
			{
		...
		$files                    = glob(DIR_SITE . '/controller/total/*.php');
			...
			foreach ($files as $file)
			{
				...
				if (!in_array($extension, $extensions))
				{
					$action[] = array(
						...
						'href' => $this->url->link('extension/total/install', '&extension=' . $extension, 'SSL')
					);
				}
				else
				{
					...
					$action[] = array(
						...
						'href' => $this->url->link('extension/total/uninstall', '&extension=' . $extension, 'SSL')
					);
				}
		...
		$this->template = 'template/extension/total.tpl';
		$this->children = array(
			'common/header',
			'common/footer'
		);
	...
	public function install()
	{
		...
		else
		{
			...
			require(DIR_SITE . '/controller/total/' . $this->request->get['extension'] . '.php');
