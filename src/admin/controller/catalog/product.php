...
class ControllerCatalogProduct extends Controller
{
	...
	private function getList()
	{
		...
		$this->data['copy']          = $this->url->link('catalog/product/copy', $url, 'SSL');
		$this->data['delete']        = $this->url->link('catalog/product/delete', $url, 'SSL');
		...
		$this->template                = 'template/catalog/product_list.tpl';
		$this->children                = array(
			'common/header',
			'common/footer'
		);
	...
	private function getForm()
	{
		...
		{
			$this->data['action'] = $this->url->link('catalog/product/update', '&product_id=' . $this->request->get['product_id'] . $url, 'SSL');
		}
		...
		$this->template        = 'template/catalog/product_form.tpl';
		$this->children        = array(
			'common/header',
			'common/footer'
		);
	...
	private function validateForm()
	{
		...
		{
			if ((mb_strlen($value['name']) < 1) || (mb_strlen($value['name']) > 255))
			{
