 ...
 * 版本: $Id: oci.php 1 2012-11-20 05:55:12Z Administrator $
...
class wcore_oci extends wcore_db
{
	...
	{
		$dbname = "(DESCRIPTION=(ADDRESS=(PROTOCOL=TCP)(HOST={$this->_db_host})(PORT={$this->_db_port}))(CONNECT_DATA=(SERVER=DEDICATED)(SERVICE_NAME={$this->_db_name})))";
