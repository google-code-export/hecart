 ...
 * 版本: $Id: phplog.php 1 2012-11-20 05:55:12Z Administrator $
...
class wcore_phplog
{
	...
	public function __construct($err_show = false, $err_path = '/tmp/')
	{
		if (ini_get('display_errors') || $err_show) //若开启了出错提示则输出错误信息
		{
			...
			set_error_handler(array(&$this, 'show_error_handler'));
			set_exception_handler(array(&$this, 'show_error_handler'));
		}
		else //普通安全等级则记录下PHP运行的日志出错信息
		{
			...
			set_exception_handler(array(&$this, 'log_error_handler'));
		}
	}
