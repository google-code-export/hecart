<?php
class Weight extends modules_mem
{
	...
	public function __construct($registry)
	{
		...
		$weight_class_query = $this->sdb()->query_res("SELECT * FROM " . DB_PREFIX . "weight_class wc LEFT JOIN " . DB_PREFIX . "weight_class_description wcd ON (wc.weight_class_id = wcd.weight_class_id) WHERE wcd.language_id = '{$this->language_id}'");
